...
┊║• ${taguser}
┊║➤ *♻️Subbot De:*
┊║• ${(conn.user.jid == global.conn.user.jid ? '' : `@${global.conn.user.jid.split`@`[0]}`) || 'No Soy Subbot'}
┊║➤ *⏳Tiempo Activo:*
┊║• ${uptime}
┊║➤ *✅Usuarios Reg:*
┊║• ${rtotalreg}
...
╎║𝐓𝐔𝐒 𝐑𝐄𝐂𝐔𝐑𝐒𝐎𝐒
╎╟•╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌•   
┊║➤ *🕹️Registrado:* ${user.registered === true ? '✅' : '❌ _#verificar_'}
┊║➤ *🧩Nivel:* ${level}
┊║➤ *🧿Experiencia:* ${exp}
┊║➤ *🧧Rango:* ${role}
┊║➤ *💎Diamantes:* ${limit}
