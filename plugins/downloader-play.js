...
const handler = async (m, {conn, command, args, text, usedPrefix}) => {
  if (!text) throw `🌌 Por favor, ingrese el nombre de la cancion, por ejemplo:

*${usedPrefix + command} Mexican phonk eki*`;
  try {
...
❒ ${yt_play[0].url}
•┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈•
𝑺𝑬 𝑬𝑺𝑻𝑨 𝑫𝑬𝑺𝑪𝑨𝑹𝑮𝑨𝑵𝑫𝑶 𝑺𝑼 𝑪𝑶𝑵𝑻𝑬𝑵𝑰𝑫𝑶
𝑷𝑶𝑹 𝑭𝑨𝑽𝑶𝑹 𝑬𝑺𝑷𝑬𝑹𝑬 𝑼𝑵 𝑴𝑶𝑴𝑬𝑵𝑻𝑶...
