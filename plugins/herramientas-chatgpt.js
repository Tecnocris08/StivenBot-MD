...
const handler = async (m, {conn, text, usedPrefix, command}) => {
  ...
  try {
        ...
        let sistema1 = `Actuaras como StivenBot-MD un bot de WhatsApp el cual fue creado por Stiven God, tu seras StivenBot-MD.`;
      ...
      try {
        conn.sendPresenceUpdate('composing', m.chat);
        const syms1 = `Actuaras como StivenBot-MD un bot de WhatsApp el cual fue creado por Stiven God, tu seras StivenBot-MD.`;
