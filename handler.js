...
${user.bannedReason ? `\n*Motivo* ${user.bannedReason}` : 'Motivo: No encontrado'}

[⛔ *NOTA* ⛔]:
*Si tu numero es baneado por error, puedes apelar esta situación en los siguientes numeros a continuación:*
...
• wa.me/5493873687620
          ...
          if (botSpam.antispam && m.text && user && user.lastCommandTime && (Date.now() - user.lastCommandTime) < 30000 && !isROwner) {
            if (user.commandCount === 2) {
              ...
              if (remainingTime > 0) {
                const messageText = `*⏱️ Por favor, espere: ${remainingTime} para usar otro comando aleatorio.*`;
                m.reply(messageText);
                return;
              } else {
                user.commandCount = 0;
        ...
        if (!isPrems && plugin.limit && global.db.data.users[m.sender].limit < plugin.limit * 1) {
          mconn.conn.reply(m.chat, `*💎 Te quedaste sin diamantes, puede usar mas usanso el comando: ${usedPrefix}buyall*`, m);
          continue; 
        }
        if (plugin.level > _user.level) {
          mconn.conn.reply(m.chat, `*⚠️ ERROR ⚠️/ Tienes que tener el nivel: ${plugin.level} para poder usar este comando..\n\nTu nivel actual es: ${_user.level}, usa el comando: ${usedPrefix}levelup para poder subir de nivel!!!*`, m);
          continue; 
        }
        const extra = {
          match,
        ...
        try {
          ...
          if (m.limit) {
            m.reply('*💎 Se gastaron/usaron: ' + +m.limit + ' diamantes!!*');
          }
        }
        break;
      }
        ...
        for (const user of participants) {
          ...
          try {
            ...
            if (userPrefix && chat.antiArab && botTt.restrict && isBotAdminNn && action === 'add') {
              ...
              await m.conn.sendMessage(id, {text: `*Hola usuario/a: @${user.split('@')[0]} en este grupo no permitimos numeros arabes o raros, por lo cual sera eliminado/a de inmediato.*`, mentions: [user]}, {quoted: fkontak2});
              return;
            }
...
export async function callUpdate(callUpdate) {
  ...
  for (const nk of callUpdate) {
    if (nk.isGroup == false) {
      if (nk.status == 'offer') {
        const callmsg = await mconn.conn.reply(nk.from, `Hola usuario/a: *@${nk.from.split('@')[0]}*, las ${nk.isVideo ? 'videollamadas' : 'llamadas'} no estan permitidos, por lo cual seras eliminado.\n\nSi la llamada o videollamada fue accidental, puedes contactar con support o con el creador del bot para darle el motivo y te desbloquee.`, false, {mentions: [nk.from]});
...
global.dfail = (type, m, conn) => {
  const msg = {
    rowner: '❮⚠️ 𝐀𝐃𝐕𝐄𝐑𝐓𝐄𝐍𝐂𝐈𝐀 / 𝐖𝐀𝐑𝐍 ⚠️❯:\n\n❬🍃❭ ➜ 𝙀𝙎𝙏𝙀 𝘾𝙊𝙈𝘼𝙉𝘿𝙊 𝙎𝙊𝙇𝙊 𝙋𝙐𝙀𝘿𝙀 𝙎𝙀𝙍 𝙀𝙅𝙀𝘾𝙐𝙏𝘼𝘿𝙊 𝙋𝙊𝙍 𝙀𝙇 𝙊𝙒𝙉𝙀𝙍 𝘿𝙀𝙇 𝘽𝙊𝙏.\n•╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌•\n𝘽𝙤𝙩: 𝘚𝘵𝘪𝘷𝘦𝘯𝘉𝘰𝘵-𝘔𝘋\n\n𝘾𝙧𝙚𝙖𝙙𝙤𝙧: 𝘚𝘵𝘪𝘷𝘦𝘯 𝘎𝘰𝘥',
    owner: '❮⚠️ 𝐀𝐃𝐕𝐄𝐑𝐓𝐄𝐍𝐂𝐈𝐀 / 𝐖𝐀𝐑𝐍 ⚠️❯:\n\n❬🌲❭ ➜ 𝙀𝙎𝙏𝙀 𝘾𝙊𝙈𝘼𝙉𝘿𝙊 𝙎𝙊𝙇𝙊 𝙋𝙐𝙀𝘿𝙀 𝙎𝙀𝙍 𝙀𝙅𝙀𝘾𝙐𝙏𝘼𝘿𝙊 𝙋𝙊𝙍 𝙀𝙇 𝘾𝙍𝙀𝘼𝘿𝙊𝙍 𝙔 𝙎𝙐𝘽𝘾𝙍𝙀𝘼𝘿𝙊𝙍 𝘿𝙀𝙇 𝘽𝙊𝙏.\n•╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌•\n𝘽𝙤𝙩: 𝘚𝘵𝘪𝘷𝘦𝘯𝘉𝘰𝘵-𝘔𝘋\n\n𝘾𝙧𝙚𝙖𝙙𝙤𝙧: 𝘚𝘵𝘪𝘷𝘦𝘯 𝘎𝘰𝘥',
    mods: '❮📛 𝐀𝐃𝐕𝐄𝐑𝐓𝐄𝐍𝐂𝐈𝐀 / 𝐖𝐀𝐑𝐍 📛❯:\n\n❬🍀❭ ➜ 𝙀𝙎𝙏𝙀 𝘾𝙊𝙈𝘼𝙉𝘿𝙊 𝙎𝙊𝙇𝙊 𝙋𝙐𝙀𝘿𝙀 𝙎𝙀𝙍 𝙀𝙅𝙀𝘾𝙐𝙏𝘼𝘿𝙊 𝙋𝙊𝙍 𝙈𝙊𝘿𝙀𝙍𝘼𝘿𝙊𝙍𝙀𝙎 𝘿𝙀𝙇 𝘽𝙊𝙏 𝙔 𝙀𝙇 𝘾𝙍𝙀𝘼𝘿𝙊𝙍.\n•╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌•\n𝘽𝙤𝙩: 𝘚𝘵𝘪𝘷𝘦𝘯𝘉𝘰𝘵-𝘔𝘋\n\n𝘾𝙧𝙚𝙖𝙙𝙤𝙧: 𝘚𝘵𝘪𝘷𝘦𝘯 𝘎𝘰𝘥',
    premium: '❮🔱 𝐀𝐃𝐕𝐄𝐑𝐓𝐄𝐍𝐂𝐈𝐀 / 𝐖𝐀𝐑𝐍 🔱❯:\n\n❬🍁❭ ➜ 𝙀𝙎𝙏𝙀 𝘾𝙊𝙈𝘼𝙉𝘿𝙊 𝙎𝙊𝙇𝙊 𝙋𝙐𝙀𝘿𝙀 𝙎𝙀𝙍 𝙀𝙅𝙀𝘾𝙐𝙏𝘼𝘿𝙊 𝙋𝙊𝙍 𝙐𝙎𝙐𝘼𝙍𝙄𝙊𝙎 𝙋𝙍𝙀𝙈𝙄𝙐𝙈 𝘿𝙀𝙇 𝘽𝙊𝙏.\n•╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌•\n𝘽𝙤𝙩: 𝘚𝘵𝘪𝘷𝘦𝘯𝘉𝘰𝘵-𝘔𝘋\n\n𝘾𝙧𝙚𝙖𝙙𝙤𝙧: 𝘚𝘵𝘪𝘷𝘦𝘯 𝘎𝘰𝘥',
    group: '❮👥 𝐀𝐃𝐕𝐄𝐑𝐓𝐄𝐍𝐂𝐈𝐀 / 𝐖𝐀𝐑𝐍 👥❯:\n\n❬🍂❭ ➜ 𝙀𝙎𝙏𝙀 𝘾𝙊𝙈𝘼𝙉𝘿𝙊 𝙎𝙊𝙇𝙊 𝙋𝙐𝙀𝘿𝙀 𝙎𝙀𝙍 𝙀𝙅𝙀𝘾𝙐𝙏𝘼𝘿𝙊 𝙀𝙉 𝙂𝙍𝙐𝙋𝙊𝙎.\n•╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌•\n𝘽𝙤𝙩: 𝘚𝘵𝘪𝘷𝘦𝘯𝘉𝘰𝘵-𝘔𝘋\n\n𝘾𝙧𝙚𝙖𝙙𝙤𝙧: 𝘚𝘵𝘪𝘷𝘦𝘯 𝘎𝘰𝘥',
    private: '❮👤 𝐀𝐃𝐕𝐄𝐑𝐓𝐄𝐍𝐂𝐈𝐀 / 𝐖𝐀𝐑𝐍 👤❯:\n\n❬🌿❭ ➜ 𝙀𝙎𝙏𝙀 𝘾𝙊𝙈𝘼𝙉𝘿𝙊 𝙎𝙊𝙇𝙊 𝙋𝙐𝙀𝘿𝙀 𝙎𝙀𝙍 𝙀𝙅𝙀𝘾𝙐𝙏𝘼𝘿𝙊 𝙀𝙉 𝙀𝙇 𝘾𝙃𝘼𝙏 𝙋𝙍𝙄𝙑𝘼𝘿𝙊.\n•╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌•\n𝘽𝙤𝙩: 𝘚𝘵𝘪𝘷𝘦𝘯𝘉𝘰𝘵-𝘔𝘋\n\n𝘾𝙧𝙚𝙖𝙙𝙤𝙧: 𝘚𝘵𝘪𝘷𝘦𝘯 𝘎𝘰𝘥',
    admin: '❮👑 𝐀𝐃𝐕𝐄𝐑𝐓𝐄𝐍𝐂𝐈𝐀 / 𝐖𝐀𝐑𝐍 👑❯:\n\n❬🌳❭ ➜ 𝙀𝙎𝙏𝙀 𝘾𝙊𝙈𝘼𝙉𝘿𝙊 𝙎𝙊𝙇𝙊 𝙋𝙐𝙀𝘿𝙀 𝙎𝙀𝙍 𝙀𝙅𝙀𝘾𝙐𝙏𝘼𝘿𝙊 𝙋𝙊𝙍 𝘼𝘿𝙈𝙄𝙉𝙄𝙎𝙏𝙍𝘼𝘿𝙊𝙍𝙀𝙎.\n•╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌•\n𝘽𝙤𝙩: 𝘚𝘵𝘪𝘷𝘦𝘯𝘉𝘰𝘵-𝘔𝘋\n\n𝘾𝙧𝙚𝙖𝙙𝙤𝙧: 𝘚𝘵𝘪𝘷𝘦𝘯 𝘎𝘰𝘥',
    botAdmin: '❮🤖 𝐀𝐃𝐕𝐄𝐑𝐓𝐄𝐍𝐂𝐈𝐀 / 𝐖𝐀𝐑𝐍 🤖❯:\n\n❬🌴❭ ➜ 𝙋𝘼𝙍𝘼 𝙀𝙇 𝙐𝙎𝙊 𝘿𝙀 𝙀𝙎𝙏𝙀 𝘾𝙊𝙈𝘼𝙉𝘿𝙊, 𝙀𝙇 𝘽𝙊𝙏 𝙏𝙄𝙀𝙉𝙀 𝙌𝙐𝙀 𝙎𝙀𝙍 𝘼𝘿𝙈𝙄𝙉.\n•╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌•\n𝘽𝙤𝙩: 𝘚𝘵𝘪𝘷𝘦𝘯𝘉𝘰𝘵-𝘔𝘋\n\n𝘾𝙧𝙚𝙖𝙙𝙤𝙧: 𝘚𝘵𝘪𝘷𝘦𝘯 𝘎𝘰𝘥',
    unreg: '❮♻️ 𝐀𝐃𝐕𝐄𝐑𝐓𝐄𝐍𝐂𝐈𝐀 / 𝐖𝐀𝐑𝐍 ♻️❯:\n\n❬🍏❭ ➜ 𝙋𝘼𝙍𝘼 𝙐𝙎𝘼𝙍 𝙀𝙎𝙏𝙀 𝘾𝙊𝙈𝘼𝙉𝘿𝙊, 𝙏𝙄𝙀𝙉𝙀𝙎 𝙌𝙐𝙀 𝙀𝙎𝙏𝘼𝙍 𝙍𝙀𝙂𝙄𝙎𝙏𝙍𝘼𝘿𝙊.\n\n𝙀𝙅𝙀𝙈𝙋𝙇𝙊𝙎:\n\n*.reg nombre.edad*\n\n𝙐𝙎𝙊 𝘾𝙊𝙍𝙍𝙀𝘾𝙏𝙊:\n\n*.reg Stiven.19*\n•╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌•\n𝘽𝙤𝙩: 𝘚𝘵𝘪𝘷𝘦𝘯𝘉𝘰𝘵-𝘔𝘋\n\n𝘾𝙧𝙚𝙖𝙙𝙤𝙧: 𝘚𝘵𝘪𝘷𝘦𝘯 𝘎𝘰𝘥',
    restrict: '❮🎋 𝐀𝐃𝐕𝐄𝐑𝐓𝐄𝐍𝐂𝐈𝐀 / 𝐖𝐀𝐑𝐍 🎋❯:\n\n❬🥪❭ ➜ 𝙀𝙎𝙏𝙀 𝘾𝙊𝙈𝘼𝙉𝘿𝙊 𝙀𝙎𝙏𝘼 𝘿𝙀𝙎𝘼𝘾𝙏𝙄𝙑𝘼𝘿𝙊 𝙋𝙊𝙍 𝙊𝙍𝘿𝙀𝙉 𝘿𝙀𝙇 𝘾𝙍𝙀𝘼𝘿𝙊𝙍.\n•╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌•\n𝘽𝙤𝙩: 𝘚𝘵𝘪𝘷𝘦𝘯𝘉𝘰𝘵-𝘔𝘋\n\n𝘾𝙧𝙚𝙖𝙙𝙤𝙧: 𝘚𝘵𝘪𝘷𝘦𝘯 𝘎𝘰𝘥',
    }[type];
