...
global.dfail = (type, m, conn) => {
  const msg = {
    rowner: '*♨️ ESTE COMANDO SOLO PUEDE SER UTILIZADO POR EL OWNER.*',
    owner: '*♨️ ESTE COMANDO SOLO PUEDE SER UTILIZADO POR EL OWNER Y SUBCREADOR.*',
    mods: '*♨️ ESTE COMANDO SOLO PUEDE SER UTILIZADO POR MODERADORES Y EL CREADOR.*',
    premium: '*♨️ ESTE COMANDO SOLO PUEDE SER UTILIZADOS POR USUARIOS PREMIUM.*',
    group: '*♨️ ESTE GRUPO SOLO PUEDE SER EJECUTADO EN GRUPOS.*',
