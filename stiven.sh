...
echo -e "\033[01;33mpkg install git -y\npkg install nodejs -y\npkg install ffmpeg -y\npkg install imagemagick -y\npkg install -y yarn\ngit clone https://github.com/tecnocris08/StivenBot-MD\ncd StivenBot-MD\nyarn install\nnpm install\nnpm start\033[0m"
exit 1
else
...
echo -e "\033[1;35m"
git clone https://github.com/tecnocris08/StivenBot-MD.git
...
menu_ayuda() {
    #printf "${v1}[${b}++${v1}]${v} StivenBot-MD${b}: "
        read opcion
        case $opcion in
            01|1)
                am start -a android.intent.action.VIEW https://chat.whatsapp.com/GtUSgN0j6ctJfLIUfCwGgL &>> /dev/null
...
echo -e "\033[01;32m\033[01mIniciando StivenBot-MD!!\nStarting StivenBot-MD!!\n\033[0m"
npm start
